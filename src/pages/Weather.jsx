...
function Weather() {
    ...
    //   form.elements.cityQuery.value = ""; // clear the value in the search box
    // })
    ...
    return(
        ...
        <div className="row align-items-center g-5 bg-[url('../public/assets/cucumber.webp')]">
          
          {/* <!-- Left content START --> */}
          <div className="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">  
            <h1>Get The Weather</h1>
            <form id="SearchForm">
              <input type="text" placeholder="Enter a city name" id="search" name="cityQuery" />
              <button onClick="pushData()">Search</button>
              <p></p>
              <h2>
                <label id="resDescription"></label><br />
                <label id="resTemps"></label>
              </h2>
            </form> 
          </div>
          {/* <!-- Left content END --> */}
